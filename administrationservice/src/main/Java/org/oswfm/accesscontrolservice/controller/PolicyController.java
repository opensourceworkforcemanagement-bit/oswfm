...
public class PolicyController {
    ...
    @GetMapping("/type/{policyTypeId}")
    @Operation(summary = "Get policies by type")
    public ResponseEntity<List<PolicyDTO>> getPoliciesByType(@PathVariable Integer policyTypeId) {
        return ResponseEntity.ok(policyService.getPoliciesByType(policyTypeId));
    }
