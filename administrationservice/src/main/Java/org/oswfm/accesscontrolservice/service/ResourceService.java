...
public class ResourceService {
    ...
    @Transactional(readOnly = true)
    public List<ResourceDTO> getResourcesByType(Integer resourceTypeId) {
        return resourceRepository.findByResourceType_ResourceTypeId(resourceTypeId).stream()
                .map(this::convertToDTO)
                .collect(Collectors.toList());
    }
    ...
    public ResourceDTO updateResource(Integer id, ResourceDTO resourceDTO) {
        ...
        ResourceType resourceType = resourceTypeRepository.findById(resourceDTO.getResourceTypeId())
                .orElseThrow(() -> new ResourceNotFoundException("ResourceType", "id", resourceDTO.getResourceTypeId()));
    ...
    private ResourceDTO convertToDTO(Resource resource) {
        ...
        dto.setResourceTypeId(resource.getResourceType().getResourceTypeId());
        dto.setResourceTypeName(resource.getResourceType().getTypeName());
    ...
    private Resource convertToEntity(ResourceDTO dto) {
        ...
        ResourceType resourceType = resourceTypeRepository.findById(dto.getResourceTypeId())
                .orElseThrow(() -> new ResourceNotFoundException("ResourceType", "id", dto.getResourceTypeId()));
