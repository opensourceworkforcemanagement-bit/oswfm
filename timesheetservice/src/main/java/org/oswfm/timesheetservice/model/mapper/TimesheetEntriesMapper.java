...
@Component
public class TimesheetEntriesMapper {

    public TimesheetEntries toEntity(TimesheetEntriesRequestDTO dto) {
        if (dto == null) {
            return null;
        }
        
        TimesheetEntries entity = new TimesheetEntries();
    ...
    public TimesheetEntriesResponseDTO toResponseDTO(TimesheetEntries entity) {
        if (entity == null) {
            return null;
        }
        
        TimesheetEntriesResponseDTO dto = new TimesheetEntriesResponseDTO();
    ...
    public void updateEntityFromDTO(TimesheetEntriesRequestDTO dto, TimesheetEntries entity) {
