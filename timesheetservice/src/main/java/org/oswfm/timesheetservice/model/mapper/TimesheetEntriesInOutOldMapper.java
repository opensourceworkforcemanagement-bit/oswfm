...
@Component
public class TimesheetEntriesInOutOldMapper {

    public TimesheetEntriesInOutOld toEntity(TimesheetEntriesInOutOldRequestDTO dto) {
        if (dto == null) {
            return null;
        }
        
        TimesheetEntriesInOutOld entity = new TimesheetEntriesInOutOld();
    ...
    public TimesheetEntriesInOutOldResponseDTO toResponseDTO(TimesheetEntriesInOutOld entity) {
        if (entity == null) {
            return null;
        }
        
        TimesheetEntriesInOutOldResponseDTO dto = new TimesheetEntriesInOutOldResponseDTO();
    ...
    public void updateEntityFromDTO(TimesheetEntriesInOutOldRequestDTO dto, TimesheetEntriesInOutOld entity) {
