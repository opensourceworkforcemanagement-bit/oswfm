...
@Component
public class TimesheetEntriesInOutArchiveMapper {

    public TimesheetEntriesInOutArchive toEntity(TimesheetEntriesInOutArchiveRequestDTO dto) {
        if (dto == null) {
            return null;
        }
        
        TimesheetEntriesInOutArchive entity = new TimesheetEntriesInOutArchive();
        ...
        entity.setSa2InTime(dto.getSa2InTime());
    ...
    public TimesheetEntriesInOutArchiveResponseDTO toResponseDTO(TimesheetEntriesInOutArchive entity) {
        if (entity == null) {
            return null;
        }
        
        TimesheetEntriesInOutArchiveResponseDTO dto = new TimesheetEntriesInOutArchiveResponseDTO();
        ...
        dto.setSa2InTime(entity.getSa2InTime());
    ...
    public void updateEntityFromDTO(TimesheetEntriesInOutArchiveRequestDTO dto, TimesheetEntriesInOutArchive entity) {
