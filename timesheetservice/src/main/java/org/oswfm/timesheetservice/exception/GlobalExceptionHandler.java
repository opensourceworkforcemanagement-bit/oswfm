...
import org.oswfm.timesheetservice.model.common.CustomError;
...
public class GlobalExceptionHandler {
    ...
    /**
     * Handles TimesheetAlreadyExistException thrown when an attempt is made to create a timesheet that already exists.
     *
     * @param ex The TimesheetAlreadyExistException instance.
     * @return ResponseEntity with CustomError indicating timesheet already exists.
     */
    @ExceptionHandler(TimesheetAlreadyExistException.class)
    public ResponseEntity<CustomError> handleTimesheetAlreadyExistException(final TimesheetAlreadyExistException ex) {
    ...
    /**
     * Handles TimesheetNotFoundException thrown when a requested timesheet is not found.
     *
     * @param ex The TimesheetNotFoundException instance.
     * @return ResponseEntity with CustomError indicating timesheet not found.
     */
    @ExceptionHandler(TimesheetNotFoundException.class)
    public ResponseEntity<CustomError> handleTimesheetNotFoundException(final TimesheetNotFoundException ex) {
        CustomError error = CustomError.builder()
                .httpStatus(HttpStatus.NOT_FOUND)
