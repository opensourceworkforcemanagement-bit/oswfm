...
public class AttributeDefinitionController {
    ...
    public ResponseEntity<List<AttributeDefinitionDTO>> getAttributeDefinitionsByCategory(@PathVariable String category) {
        return ResponseEntity.ok(attributeDefinitionService.getAttributeDefinitionsByCategory(category));
    }
