...
class UserControllerTest extends AbstractRestControllerTest {
    ...
    @Test
    void givenValidRegisterRequest_whenRegisterUser_thenSuccess() throws Exception {
    ...
    @Test
    void givenTokenInvalidateRequest_WhenLogoutForUser_ThenReturnSuccess() throws Exception {

        // Given
        TokenInvalidateRequest tokenInvalidateRequest = TokenInvalidateRequest.builder()
                .accessToken("Bearer validAccessToken")
